...
export default function Home() {
    ...
    <>
        <div className='aside animate__animated animate__fadeInLeft animate__delay-0.5s'>
            ...
            <p className='p1'>Lorem Ipsum has been the industry's 
                standard dummy text ever since the 1500s  </p>
                {/* <marquee behavior="scroll" >Made with love by Rupali Bisale.</marquee> */}
                <div className="scroll-text">Made with love by Rupali Bisale.</div>
